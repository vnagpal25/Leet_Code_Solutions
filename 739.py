class Solution:
    def dailyTemperatures(self, temperatures: list[int]) -> list[int]:
        ...
        # contains a backlog of seen temperatures, will only pop off an element if we encounter a greater element than the top
        temp_stack = [] 
        ...
        for i, temp in enumerate(temperatures):
            ...
            # continues through while loop until we encounter a value in the stack that is >= than the current value
